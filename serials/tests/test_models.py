...
class TVSeriesModelTest(TestCase):
    ...
    def setUpTestData(cls):
        cls.user = get_user_model().objects.create_user("User1", "user1@mail.com")
    ...
    def test_series_listing(self):
        ...
        self.actor = Crew.objects.create(name="Zach Braff", slug="zach-braff")
        self.director = Crew.objects.create(name="Bill Lawrence", slug="bill-lawrence")
...
class CommentModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.comment = Comment.objects.create(
            series=cls.series, author=cls.user, text="The best series"
        )
